...
def talker():
    joint_states_pub = rospy.Publisher('UR10_joints_state',Floats,queue_size=10)
    robot_state_pub  = rospy.Publisher('UR10_end_effector_position', Floats, queue_size=10)
