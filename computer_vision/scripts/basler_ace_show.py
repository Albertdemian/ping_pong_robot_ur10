...
class Basler_Ace_Camera():
    ...
    def record(self):
        ...
        self.camera.StartGrabbing() # Starts recording
    ...
    def track_the_ball(self, buffer_size = 64, path = 'Pictures/', ball_diameter = 40, k = 2):
        ...
        while self.camera.IsGrabbing():
            ...
            if grabResult.GrabSucceeded():
                ...
                hsv = cv2.cvtColor(blurred, cv2.COLOR_GRAY2BGR)
...
# camera.collect_images(number_of_images=1, path = 'HSV_get')

# camera.camera_calibrate()

camera.track_the_ball()
